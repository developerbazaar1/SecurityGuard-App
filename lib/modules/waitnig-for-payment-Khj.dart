                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 15*fem,
                      child: Image.asset(
                        'assets/modules/images/time-SSm.png',
                        width: 39.77*fem,
                        height: 15*fem,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13*fem,
                            child: Image.asset(
                              'assets/modules/images/cellular-connection-ctq.png',
                              width: 22*fem,
                              height: 13*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/modules/images/wifi-yWH.png',
                              width: 21.21*fem,
                              height: 15*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/modules/images/battery-q5K.png',
                              width: 30*fem,
                              height: 15*fem,
                            ),
                          ),
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    height: 229.57*fem,
                    child: Image.asset(
                      'assets/modules/images/dazzle-customer-care-2.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
