                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 15*fem,
                        child: Image.asset(
                          'assets/modules/images/time-Hg5.png',
                          width: 39.77*fem,
                          height: 15*fem,
                        ),
                      ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 13*fem,
                              child: Image.asset(
                                'assets/modules/images/cellular-connection-YEd.png',
                                width: 22*fem,
                                height: 13*fem,
                              ),
                            ),
                            Container(
                              ...
                              height: 15*fem,
                              child: Image.asset(
                                'assets/modules/images/wifi-o85.png',
                                width: 21.21*fem,
                                height: 15*fem,
                              ),
                            ),
                            Container(
                              ...
                              height: 15*fem,
                              child: Image.asset(
                                'assets/modules/images/battery-pg9.png',
                                width: 30*fem,
                                height: 15*fem,
                              ),
                            ),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      height: 300*fem,
                      child: Image.asset(
                        'assets/modules/images/dazzle-online-banking-1-pxh.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                    SizedBox(
