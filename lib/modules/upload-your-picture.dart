      ...
      child: Container(
        ...
        decoration: BoxDecoration (
          ...
          image: DecorationImage (
            fit: BoxFit.cover,
            image: AssetImage (
              'assets/modules/images/rectangle-7-bg-XyB.png',
            ),
          ),
        ),
        child: Column(
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 15*fem,
                      child: Image.asset(
                        'assets/modules/images/time-yvZ.png',
                        width: 39.77*fem,
                        height: 15*fem,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13*fem,
                            child: Image.asset(
                              'assets/modules/images/cellular-connection-Bhs.png',
                              width: 22*fem,
                              height: 13*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/modules/images/wifi-mW1.png',
                              width: 21.21*fem,
                              height: 15*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/modules/images/battery-JUh.png',
                              width: 30*fem,
                              height: 15*fem,
                            ),
                          ),
              ...
              child: Row(
                ...
                children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 16.68*fem,
                              child: Image.asset(
                                'assets/modules/images/fluent-ios-arrow-24-filled-2sj.png',
                                width: 8.76*fem,
                                height: 16.68*fem,
                              ),
                            ),
                  ...
                  Container(
                    ...
                    height: 80*fem,
                    child: Image.asset(
                      'assets/modules/images/raynet-final-logo-1-T8V.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                height: 23.13*fem,
                                child: Image.asset(
                                  'assets/modules/images/bytesize-upload.png',
                                  width: 25.32*fem,
                                  height: 23.13*fem,
                                ),
                              ),
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                height: 23.13*fem,
                                child: Image.asset(
                                  'assets/modules/images/bytesize-upload-bEZ.png',
                                  width: 25.32*fem,
                                  height: 23.13*fem,
                                ),
                              ),
