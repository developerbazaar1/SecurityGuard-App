                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 15*fem,
                      child: Image.asset(
                        'assets/modules/images/time-drZ.png',
                        width: 39.77*fem,
                        height: 15*fem,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13*fem,
                            child: Image.asset(
                              'assets/modules/images/cellular-connection-gPK.png',
                              width: 22*fem,
                              height: 13*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/modules/images/wifi-8Uy.png',
                              width: 21.21*fem,
                              height: 15*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/modules/images/battery-UAV.png',
                              width: 30*fem,
                              height: 15*fem,
                            ),
                          ),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 40*fem,
                    child: Image.asset(
                      'assets/modules/images/raynet-final-logo-1-ujo.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
                    ...
                    height: 30*fem,
                    child: Image.asset(
                      'assets/modules/images/mingcute-notification-line-d5s.png',
                      width: 30*fem,
                      height: 30*fem,
                    ),
                  ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 25.01*fem,
                            child: Image.asset(
                              'assets/modules/images/fluent-ios-arrow-24-filled-3n9.png',
                              width: 13.14*fem,
                              height: 25.01*fem,
                            ),
                          ),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration (
                                  ...
                                  image: DecorationImage (
                                    fit: BoxFit.cover,
                                    image: AssetImage (
                                      'assets/modules/images/ellipse-1-bg-z57.png',
                                    ),
                                  ),
                                ),
                              ),
