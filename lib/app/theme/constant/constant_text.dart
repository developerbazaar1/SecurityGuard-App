...
class C {
  ...
  /*       margins     */
 // static double margin = width;
  static double margin = 16;
  static double buttonRadius = 25;
  static double iconButtonRadius = 25;
  static double textButtonRadius = 10;
  static double loginTextFieldRadius = 10;
  static var wooEnglishAppLogoMargin = 60;
  ...
  static const textComfirmRequest = "Confirm";
  ...
  static var bookImageInGridHeight = 170;
  static var bookImageInGridWidth = 148;
  static var bookImageInGridRadius = 7;
  static var bookCardInGridRadius = 10;
  static var bookCardInGridHeight = 270;

  static var bookHorizontalListCardHeight = 248;
  static var bookHorizontalListCardWidth = 130;
  static var bookHorizontalListHeight = 170;
  static var bookHorizontalListWidth = 130;
  static var bookHorizontalListRadius = 10;
  static var bookHorizontalListMargin = 16;
}
