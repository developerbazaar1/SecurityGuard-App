                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/time-cCH.png',
                              width: 39.77*fem,
                              height: 15*fem,
                            ),
                          ),
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  height: 13*fem,
                                  child: Image.asset(
                                    'assets/page-2/images/cellular-connection-JhF.png',
                                    width: 22*fem,
                                    height: 13*fem,
                                  ),
                                ),
                                Container(
                                  ...
                                  height: 15*fem,
                                  child: Image.asset(
                                    'assets/page-2/images/wifi-EJu.png',
                                    width: 21.21*fem,
                                    height: 15*fem,
                                  ),
                                ),
                                Container(
                                  ...
                                  height: 15*fem,
                                  child: Image.asset(
                                    'assets/page-2/images/battery-iUy.png',
                                    width: 30*fem,
                                    height: 15*fem,
                                  ),
                                ),
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          height: 40*fem,
                          child: Image.asset(
                            'assets/page-2/images/raynet-final-logo-1-RiH.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                        Container(
                          ...
                          height: 30*fem,
                          child: Image.asset(
                            'assets/page-2/images/mingcute-notification-line-B8u.png',
                            width: 30*fem,
                            height: 30*fem,
                          ),
                        ),
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            child: Container(
                              ...
                              height: 30*fem,
                              child: Image.asset(
                                'assets/page-2/images/fluent-ios-arrow-24-filled-oqj.png',
                                width: 30*fem,
                                height: 30*fem,
                              ),
                            ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          height: 229.57*fem,
                          child: Image.asset(
                            'assets/page-2/images/dazzle-customer-care-1-Md3.png',
                            fit: BoxFit.cover,
                          ),
                        ),
                        Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: 30*fem,
                                      child: Image.asset(
                                        'assets/page-2/images/group-138-dNh.png',
                                        width: 30*fem,
                                        height: 30*fem,
                                      ),
                                    ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: 30*fem,
                                      child: Image.asset(
                                        'assets/page-2/images/group-139-HfX.png',
                                        width: 30*fem,
                                        height: 30*fem,
                                      ),
                                    ),
