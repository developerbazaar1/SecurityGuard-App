...
class LoginController extends GetxController{
  ...
  void loginApi(BuildContext context)async{
    ...
    try{
      var request = http.MultipartRequest('POST', Uri.parse('http://pragya.dbtechserver.online/security/api/auth/login'));
      ...
      if (response.statusCode == 200) {
        ...
        if(LoginData.value['status']==true){
          ...
          Get.snackbar('Login Successful', LoginData.value['message'],colorText: ThemeColortDark);
        ...
        print(data);
        Get.snackbar('Login failed', LoginData.value['message'],colorText: ThemeColorError);
      }
