                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 15*fem,
                      child: Image.asset(
                        'assets/page-2/images/time-ZDb.png',
                        width: 39.77*fem,
                        height: 15*fem,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13*fem,
                            child: Image.asset(
                              'assets/page-2/images/cellular-connection-xwB.png',
                              width: 22*fem,
                              height: 13*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/wifi-UU1.png',
                              width: 21.21*fem,
                              height: 15*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/battery-R9s.png',
                              width: 30*fem,
                              height: 15*fem,
                            ),
                          ),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 40*fem,
                    child: Image.asset(
                      'assets/page-2/images/raynet-final-logo-1-JMo.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                  Container(
                    ...
                    height: 30*fem,
                    child: Image.asset(
                      'assets/page-2/images/mingcute-notification-line-CFB.png',
                      width: 30*fem,
                      height: 30*fem,
                    ),
                  ),
                        ...
                        Container(
                          ...
                          child: TextButton(
                            ...
                            child: Container(
                              ...
                              height: 30*fem,
                              child: Image.asset(
                                'assets/page-2/images/fluent-ios-arrow-24-filled-TwF.png',
                                width: 30*fem,
                                height: 30*fem,
                              ),
                            ),
