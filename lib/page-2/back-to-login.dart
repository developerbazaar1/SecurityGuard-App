      ...
      child: Container(
        ...
        decoration: BoxDecoration (
          ...
          image: DecorationImage (
            fit: BoxFit.cover,
            image: AssetImage (
              'assets/page-2/images/rectangle-7-bg-TX7.png',
            ),
          ),
        ),
        child: Column(
          ...
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 15*fem,
                      child: Image.asset(
                        'assets/page-2/images/time-Tcu.png',
                        width: 39.77*fem,
                        height: 15*fem,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13*fem,
                            child: Image.asset(
                              'assets/page-2/images/cellular-connection-S4Z.png',
                              width: 22*fem,
                              height: 13*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/wifi-4dX.png',
                              width: 21.21*fem,
                              height: 15*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/battery-MwP.png',
                              width: 30*fem,
                              height: 15*fem,
                            ),
                          ),
            ...
            Container(
              ...
              height: 80*fem,
              child: Image.asset(
                'assets/page-2/images/raynet-final-logo-1-8eM.png',
                fit: BoxFit.cover,
              ),
            ),
            Container(
