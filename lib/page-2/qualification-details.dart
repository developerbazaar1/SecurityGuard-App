      ...
      child: Container(
        ...
        decoration: BoxDecoration (
          ...
          image: DecorationImage (
            fit: BoxFit.cover,
            image: AssetImage (
              'assets/page-2/images/rectangle-7-bg-Vr1.png',
            ),
          ),
        ),
        child: Column(
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 15*fem,
                      child: Image.asset(
                        'assets/page-2/images/time-iws.png',
                        width: 39.77*fem,
                        height: 15*fem,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13*fem,
                            child: Image.asset(
                              'assets/page-2/images/cellular-connection-diy.png',
                              width: 22*fem,
                              height: 13*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/wifi-khP.png',
                              width: 21.21*fem,
                              height: 15*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/battery-wPw.png',
                              width: 30*fem,
                              height: 15*fem,
                            ),
                          ),
              ...
              child: Row(
                ...
                children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 16.68*fem,
                              child: Image.asset(
                                'assets/page-2/images/fluent-ios-arrow-24-filled-bah.png',
                                width: 8.76*fem,
                                height: 16.68*fem,
                              ),
                            ),
                  ...
                  Container(
                    ...
                    height: 80*fem,
                    child: Image.asset(
                      'assets/page-2/images/raynet-final-logo-1-n8y.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
                          ...
                          child: Align(
                            child: SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: Image.asset(
                                  'assets/page-2/images/component-15.png',
                                  width: 19.5*fem,
                                  height: 19.5*fem,
                                ),
                              ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: 23.13*fem,
                                      child: Image.asset(
                                        'assets/page-2/images/bytesize-upload-Fhs.png',
                                        width: 25.32*fem,
                                        height: 23.13*fem,
                                      ),
                                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: 23.13*fem,
                                      child: Image.asset(
                                        'assets/page-2/images/bytesize-upload-4C9.png',
                                        width: 25.32*fem,
                                        height: 23.13*fem,
                                      ),
                                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      height: 23.13*fem,
                                      child: Image.asset(
                                        'assets/page-2/images/bytesize-upload-74D.png',
                                        width: 25.32*fem,
                                        height: 23.13*fem,
                                      ),
                                    ),
