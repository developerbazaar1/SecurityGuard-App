...
class HomePageController extends GetxController{
  ...
  RxString text = "Please click the 'GO' button to access our online platform.".obs;
  ...
  void updateSize() {
    srink.value = true;
      ...
      text.value = srink.value?"You will receive a notification when someone hires your security services.":"Please click the 'GO' button to access our online platform.";
