                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 15*fem,
                      child: Image.asset(
                        'assets/page-2/images/time-jkD.png',
                        width: 39.77*fem,
                        height: 15*fem,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13*fem,
                            child: Image.asset(
                              'assets/page-2/images/cellular-connection-Pcm.png',
                              width: 22*fem,
                              height: 13*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/wifi-9jf.png',
                              width: 21.21*fem,
                              height: 15*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 15*fem,
                            child: Image.asset(
                              'assets/page-2/images/battery-6C9.png',
                              width: 30*fem,
                              height: 15*fem,
                            ),
                          ),
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    height: 300*fem,
                    child: Image.asset(
                      'assets/page-2/images/dazzle-online-banking-2.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                  SizedBox(
