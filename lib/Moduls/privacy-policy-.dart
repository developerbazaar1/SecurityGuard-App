                          ...
                          Container(
                            ...
                            child: TextButton(
                              ...
                              child: Container(
                                ...
                                height: 30*fem,
                                child: Image.asset(
                                  'assets/page-2/images/fluent-ios-arrow-24-filled-mQd.png',
                                  width: 30*fem,
                                  height: 30*fem,
                                ),
                              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 15*fem,
                              child: Image.asset(
                                'assets/page-2/images/time-hGd.png',
                                width: 39.77*fem,
                                height: 15*fem,
                              ),
                            ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 13*fem,
                                    child: Image.asset(
                                      'assets/page-2/images/cellular-connection-Avd.png',
                                      width: 22*fem,
                                      height: 13*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 15*fem,
                                    child: Image.asset(
                                      'assets/page-2/images/wifi-Fey.png',
                                      width: 21.21*fem,
                                      height: 15*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 15*fem,
                                    child: Image.asset(
                                      'assets/page-2/images/battery-uqK.png',
                                      width: 30*fem,
                                      height: 15*fem,
                                    ),
                                  ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 40*fem,
                            child: Image.asset(
                              'assets/page-2/images/raynet-final-logo-1-AHX.png',
                              fit: BoxFit.cover,
                            ),
                          ),
                          Container(
                            ...
                            height: 30*fem,
                            child: Image.asset(
                              'assets/page-2/images/mingcute-notification-line-7TF.png',
                              width: 30*fem,
                              height: 30*fem,
                            ),
                          ),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 40*fem,
                      child: Image.asset(
                        'assets/page-2/images/raynet-final-logo-1-Ku3.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                    Container(
                      ...
                      height: 30*fem,
                      child: Image.asset(
                        'assets/page-2/images/mingcute-notification-line-WA5.png',
                        width: 30*fem,
                        height: 30*fem,
                      ),
                    ),
