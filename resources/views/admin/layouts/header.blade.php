      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Provider</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{ route('vendors')}}"><i class="icon fa fa-book"></i>Provider Info</a></li>
            <li><a class="treeview-item" href="{{ route('bookings')}}"><i class="icon fa fa-book"></i>Booking Details</a></li>
            <li><a class="treeview-item" href="{{ route('withdraws')}}" rel="noopener"><i class="icon fa fa-money"></i>Withdraw Request</a></li>
          </ul>
        </li>
